#ifndef CAFFE_BL_LAYER_HPP_
#define CAFFE_BL_LAYER_HPP_
...
class BlLayer : public Layer<Dtype> {
 public:
  /**
   ...
   */
  explicit BlLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "Bl"; }
