#ifndef CAFFE_MAKE_SIGNAL_FIX_LAYER_HPP_
#define CAFFE_MAKE_SIGNAL_FIX_LAYER_HPP_
...
class MakeSignalFixLayer : public Layer<Dtype> {
 public:
  /**
   ...
   */
  explicit MakeSignalFixLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "MakeSignalFix"; }
